...
//				PdfWriter.ENCRYPTION_AES_128);
		...
		HeaderAndSignatureEvent1 event = new HeaderAndSignatureEvent1(headers);
	...
	public static void main(String[] args) {
		...
		try {
			Generate3 generate = new Generate3();
...
class HeaderAndSignatureEvent1 extends PdfPageEventHelper {

	private List<String> headers;
	private boolean isFirstPage = true;

	public HeaderAndSignatureEvent1(List<String> headers) {
